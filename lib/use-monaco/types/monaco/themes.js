...
const strip_comments_1 = tslib_1.__importDefault(require("./utils/strip-comments"));
const plugin_api_1 = require("./plugin-api");
exports.default = plugin_api_1.createPlugin({ name: 'core.themes', dependencies: ['core.editors'] }, (monaco) => {
    ...
    monaco.editor.setTheme = (theme) => {
        if (typeof theme === 'string') {
            try {
                const resolvedTheme = JSON.parse(strip_comments_1.default(theme));
