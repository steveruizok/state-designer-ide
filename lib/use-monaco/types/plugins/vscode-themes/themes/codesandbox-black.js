...
const dot_object_1 = tslib_1.__importDefault(require("dot-object"));
...
*/
const colors = {
    contrastBorder: colors_1.colors.blueGray[600],
    contrastActiveBorder: null,
    errorForeground: colors_1.colors.red[500],
    focusBorder: colors_1.colors.blueGray[600],
    foreground: colors_1.colors.blueGray[200],
    activityBar: {
        background: colors_1.colors.blueGray[700],
        border: colors_1.colors.blueGray[600],
    },
    activityBarBadge: {
        background: colors_1.colors.blueGray[500],
    },
    button: {
        background: colors_1.colors.blue[600],
        foreground: colors_1.colors.white,
        border: colors_1.colors.blue[600],
    },
    dropdown: {
        background: colors_1.colors.blueGray[700],
        border: colors_1.colors.blueGray[600],
    ...
    editor: {
        background: colors_1.colors.blueGray[700],
        foreground: colors_1.colors.blueGray[300],
        hoverHighlightBackground: colors_1.colors.blueGray[500],
        inactiveSelectionBackground: colors_1.colors.blueGray[500],
        lineHighlightBackground: colors_1.colors.blueGray[600],
        lineHighlightBorder: colors_1.colors.blueGray[600],
        rangeHighlightBackground: colors_1.colors.blueGray[600],
        selectionBackground: colors_1.colors.blue[500] + "33",
        selectionHighlightBackground: colors_1.colors.blueGray[600],
        wordHighlightStrongBackground: colors_1.colors.blueGray[600],
        wordHighlightBackground: colors_1.colors.blueGray[600],
    },
    editorBracketMatch: {
        background: colors_1.colors.blueGray[600],
    },
    editorCodeLens: {
        foreground: colors_1.colors.blueGray[600],
    },
    editorCursor: {
        background: colors_1.colors.blueGray[700],
        foreground: colors_1.colors.white,
    ...
    editorError: {
        border: colors_1.colors.blueGray[600],
        foreground: colors_1.colors.red[500],
    },
    editorGroup: {
        background: colors_1.colors.blueGray[700],
        border: colors_1.colors.blueGray[600],
        dropBackground: colors_1.colors.blue[500] + "1a",
    },
    editorGroupHeader: {
        noTabsBackground: null,
        tabsBackground: colors_1.colors.blueGray[700],
        tabsBorder: colors_1.colors.blueGray[600],
    },
    editorGutter: {
        background: colors_1.colors.blueGray[700],
        deletedBackground: colors_1.colors.red[500],
        modifiedBackground: colors_1.colors.blueGray[700],
    },
    editorHoverWidget: {
        background: colors_1.colors.blueGray[700],
        border: colors_1.colors.blueGray[600],
    ...
    editorLink: {
        activeForeground: colors_1.colors.blueGray[300],
    },
    editorLineNumber: {
        foreground: colors_1.colors.blueGray[600],
        activeForeground: colors_1.colors.blueGray[400],
    },
    editorRuler: {
        foreground: colors_1.colors.white,
    },
    ...
    editorOverviewRuler: {
        border: colors_1.colors.blueGray[600],
        commonContentForeground: colors_1.colors.blueGray[600],
        currentContentForeground: colors_1.colors.red[500],
    ...
    editorSuggestWidget: {
        ...
        border: colors_1.colors.blueGray[600],
        foreground: colors_1.colors.blueGray[300],
        selectedBackground: colors_1.colors.blueGray[600],
    },
    editorWarning: {
        border: colors_1.colors.blueGray[600],
        foreground: colors_1.colors.red[300],
    },
    editorWhitespace: {
        foreground: colors_1.colors.blueGray[500],
    },
    editorWidget: {
        background: colors_1.colors.blueGray[700],
        border: colors_1.colors.blueGray[600],
    ...
    extensionButton: {
        prominentBackground: colors_1.colors.blueGray[600],
        prominentForeground: colors_1.colors.white,
        prominentHoverBackground: colors_1.colors.blueGray[600],
    },
    input: {
        background: colors_1.colors.blueGray[600],
        foreground: colors_1.colors.white,
        border: colors_1.colors.blueGray[900],
        placeholderForeground: colors_1.colors.blueGray[300],
    },
    inputOption: {
        activeBorder: colors_1.colors.blueGray[500],
    },
    inputValidation: {
        infoForeground: null,
        infoBackground: null,
        ...
        errorBorder: colors_1.colors.red[500],
    },
    list: {
        dropBackground: colors_1.colors.blueGray[700],
        highlightForeground: colors_1.colors.blue[300],
        hoverBackground: colors_1.colors.blueGray[600],
        focusBackground: colors_1.colors.blueGray[600],
        activeSelectionBackground: colors_1.colors.blueGray[600],
        activeSelectionForeground: colors_1.colors.white,
        inactiveSelectionBackground: colors_1.colors.blueGray[600],
    ...
    menu: {
        background: colors_1.colors.blueGray[700],
        selectionBackground: colors_1.colors.blueGray[600],
    },
    peekView: {
        border: colors_1.colors.blueGray[500],
    },
    peekViewEditor: {
        background: colors_1.colors.blueGray[600],
        matchHighlightBackground: colors_1.colors.blue[500] + "33",
    },
    ...
    peekViewTitleDescription: {
        foreground: colors_1.colors.blue[700],
    },
    peekViewTitleLabel: {
        foreground: colors_1.colors.white,
    },
    ...
    selection: {
        background: colors_1.colors.blue[500] + "40",
    },
    separator: {
        background: colors_1.colors.blueGray[900],
        foreground: colors_1.colors.white,
    },
    sideBar: {
        background: colors_1.colors.blueGray[700],
    ...
    statusBar: {
        background: colors_1.colors.blueGray[600],
        foreground: colors_1.colors.white,
        debuggingBackground: colors_1.colors.red[500],
        debuggingForeground: colors_1.colors.blueGray[600],
        noFolderBackground: colors_1.colors.blueGray[600],
    ...
    statusBarItem: {
        ...
        hoverBackground: null,
        prominentBackground: colors_1.colors.red[500],
        prominentHoverBackground: colors_1.colors.yellow,
        remoteForeground: colors_1.colors.blueGray[100],
        remoteBackground: colors_1.colors.purple,
    },
    tab: {
        activeBackground: colors_1.colors.blueGray[700],
        activeForeground: colors_1.colors.white,
        border: colors_1.colors.blueGray[600],
        activeBorder: colors_1.colors.blue[300],
        unfocusedActiveBorder: null,
        inactiveBackground: colors_1.colors.blueGray[700],
        inactiveForeground: colors_1.colors.blueGray[400],
        unfocusedActiveForeground: colors_1.colors.white,
        unfocusedInactiveForeground: colors_1.colors.blueGray[400],
    },
    terminal: {
        background: colors_1.colors.blueGray[700],
        foreground: colors_1.colors.white,
        ansiBrightBlack: colors_1.colors.blue[700],
        ansiBrightRed: colors_1.colors.red[500],
        ansiBrightGreen: colors_1.colors.green,
        ansiBrightYellow: colors_1.colors.yellow,
        ansiBlack: colors_1.colors.blueGray[600],
        ansiRed: colors_1.colors.red[500],
        ansiGreen: colors_1.colors.green,
        ansiYellow: colors_1.colors.yellow,
        ansiBlue: colors_1.colors.blue[700],
        ansiMagenta: colors_1.colors.purple,
        ansiCyan: colors_1.colors.blue[300],
    ...
    titleBar: {
        ...
        border: colors_1.colors.blueGray[600],
        inactiveBackground: colors_1.colors.blueGray[700],
        inactiveForeground: colors_1.colors.blueGray[300],
    },
};
const theme = {
...
//# sourceMappingURL=codesandbox-black.js.map